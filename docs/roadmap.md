...
- [ ] 使用真实韩语节目完成一次打包 App 的识别、翻译、编辑、导出与烧录回归。
...
- 当前识别与翻译选项已可配置；UI 暴露日语、英语或韩语到简体中文，并将语言对持久化到任务、SQLite、词表和导出。日语与英语真实节目均已在打包窗口中完成识别、DeepL 翻译、编辑、导出与烧录回归；韩语仍需分别验证真实 Whisper、provider 与字幕排版质量。
