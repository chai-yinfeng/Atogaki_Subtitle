...
3. macOS Apple Silicon 继续作为日常开发与发布质量基线；Windows 下一候选先恢复明确的 NSIS current-user／中英配置并分诊悬浮字幕，再集中验证 alpha.6 后的学习区、词典、字体样式、任务排序、可恢复翻译、局部重新识别、长视频 Range 播放和导出质量档。
